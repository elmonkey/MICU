...
ctrl+alt+t
sudo ifconfig eth0 192.168.0.12 netmask 255.255.255.0 # landline
sudo ifconfig wlan0 192.168.0.12 netmask 255.255.255.0 # wireless
# Activate server
python server_threads.py # first terminal
python dev2_videos.py # second terminal
